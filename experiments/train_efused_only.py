"""Train UMPA-SAM with ONLY E_fused (no E_sparse) on all 5 datasets.
...
Usage:
    python experiments/train_efused_only.py
    python experiments/train_efused_only.py --dry-run
    python experiments/train_efused_only.py --dataset kvasir_seg
"""
...
from experiments.wrappers import EFusedOnlyWrapper
...
def train_scenario(
    ...
    """Train E_fused-only model on a single dataset."""
    print(f"\n{'='*60}")
    ...
    model = EFusedOnlyWrapper(base_model)
